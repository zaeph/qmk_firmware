...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT_moonlander(
                             ...
                             KC_BSPC,    MO(SYMB),   KC_LALT,                                                                                                    KC_LALT,    MO(SYMB),   KC_SPC),
  ...
  [SYMB] = LAYOUT_moonlander(
                             ...
                             _______,    KC_F24,     KC_LT,      KC_GT,      KC_DQT,     KC_DOT,     _______,    _______,    KC_AMPR,    KC_ASTR,    KC_LBRC,    KC_RBRC,    KC_PERC,    _______,
                             _______,    KC_EXLM,    KC_MINS,    KC_PLUS,    KC_EQUAL,   KC_HASH,    _______,    _______,    KC_PIPE,    KC_COLN,    KC_LPRN,    KC_RPRN,    KC_QUES,    _______,
                             _______,    KC_CIRC,    KC_SLSH,    KC_ASTR,    KC_BSLS,    ZP_UPDIR,                           KC_TILD,    KC_DLR,     KC_LCBR,    KC_RCBR,    KC_AT,      _______,
