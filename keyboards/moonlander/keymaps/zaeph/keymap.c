...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |--------+------+------+------+------+------|------|           |------|------+------+------+------+------+--------|
   * |LCTL/ESC|   A  |   S  |   D  |   F  |   G  | DEL  |           |   )  |   H  |   J  |   K  |   L  |   ;  |   ’    |
   * |--------+------+------+------+------+------|------´           `------|------+------+------+------+------+--------|
   * |  LSFT  |   Z  |   X  |   C  |   V  |   B  |                         |   N  |   M  |   ,  |   .  |   /  |  RSFT  |
   * |--------+------+------+------+------+------´                         `------+------+------+------+------+--------|
   * | ~META  | CMD  | LALT | RALT | RALT |  .-------------.     .-------------.  | RALT | DOWN |  UP  | RIGHT| ~META  |
   *  `-----------------------------------´  |    HYPER    |     |    SUPER    |  `------------------------------------´
   *                                  .------+------+------|     |------+------+------.
   *                                  |      |      |      |     |      |      |      |
   *                                  | BSPC | LALT |~META |     |~META | RET  | SPC  |
   *                                  |      |      |      |     |      |      |      |
   *                                  `--------------------´     `--------------------´
   */
  ...
  [BASE] = LAYOUT_moonlander(
                             ...
                             LCTL_T(KC_ESC), KC_A, KC_S, KC_D, KC_F, KC_G, KC_DEL, KC_RPRN, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOTE,
                             KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLASH, KC_RSFT,
                             MO(META), KC_LGUI, KC_LALT, KC_RALT, KC_RALT, KC_RGUI, KC_LGUI, KC_RALT, KC_DOWN, KC_UP, KC_RIGHT, MO(META),
                             KC_BSPC, KC_LALT, MO(META), MO(META), KC_ENT, KC_SPC),
  ...
  [META] = LAYOUT_moonlander(
                             ...
                             _______, _______, _______, _______, _______, _______,  KC_QUOT, _______, KC_HOME, KC_LBRC,KC_RBRC,  KC_END, KC_PSCR, KC_F12,
                             _______, _______, _______, _______, _______, _______,  _______, _______, _______, KC_LPRN, KC_RPRN, KC_RIGHT, _______, _______,
