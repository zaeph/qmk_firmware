 ...
 * Copyright 2021-2023 Leo Vivier
 *
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------|
   * | ENDA |  Z   |  X   |  C   |  V   |  B   |  N   |  M   |  ,   |  .   |  /   | MINS |
   * |------+------+------+------+------+------+------+------+------+------+------+------|
   * | ~FUNC|      |      | ~TYCP| ~SYSF|    Space    | ~SYRT| RAIN | Down |  Up  | Right|
   * `-----------------------------------------------------------------------------------´
   */

  [BASE] = LAYOUT_planck_grid(
                              KC_TAB,     KC_Q,        KC_W,        KC_E,        KC_R,        KC_T,        KC_Y,       KC_U,        KC_I,        KC_O,        KC_P,        KC_BSPC,
                              KC_ESC,     KC_A,        KC_S,        KC_D,        KC_F,        KC_G,        KC_H,       KC_J,        KC_K,        KC_L,        ZP_UNDS,     ZP_CQUT,
                              ZP_ENDA,    KC_Z,        KC_X,        KC_C,        KC_V,        KC_B,        KC_N,       KC_M,        KC_COMM,     KC_DOT,      KC_SLSH,     ZP_MINS,
                              MO(FUNC),   KC_MEH,      _______,     ZP_TYCP,     ZP_SYSF,     KC_SPC,      KC_SPC,     ZP_SYRT,     ZP_RAIN,     KC_DOWN,     KC_UP,       MO(LSYM)),
  ...
  [LSYM] = LAYOUT_planck_grid(
                              _______,    ZP_QUES,    KC_MINS,     ZP_LABK,     ZP_RABK,     KC_GRAVE,    _______,     _______,    _______,     _______,     _______,     _______,
                              _______,    ZP_EXCL,    KC_PLUS,     KC_COLN,     KC_EQL,      KC_HASH,     _______,     _______,    _______,     _______,     _______,     _______,
                              _______,    KC_CIRC,    KC_SLSH,     KC_ASTR,     ZP_SCLN,     ZP_WLRS,     _______,     _______,    _______,     _______,     _______,     _______,
                              _______,    MO(FUNC),   KC_MEH,      _______,     KC_C,        _______,     KC_SPC,      KC_SPC,     _______,     _______,     _______,     _______),
  ...
  [RSYM] = LAYOUT_planck_grid(
                         _______,    _______,     _______,     _______,     _______,     _______,     KC_AMPR,     KC_LCBR,    KC_RCBR,     KC_PERC,     KC_GRAVE,    _______,
                         _______,    _______,     _______,     _______,     _______,     _______,     KC_PIPE,     KC_LPRN,    KC_RPRN,     KC_DLR,      KC_DQT,      ZP_QUOT,
  ...
  [TYPO] = LAYOUT_planck_grid(
                         _______,    _______,     _______,     _______,     _______,     _______,     _______,    ZP_CGUO,     ZP_CGUC,     TY_DEGR,     ZP_PRIM,     _______,
                         _______,    _______,     _______,     _______,     _______,     _______,     ZP_ELLP,    ZP_CQTO,     ZP_CQTC,     ZP_ENEM,     FR_COLN,     _______,
                         _______,    _______,     _______,     _______,     _______,     _______,     _______,    ZP_INBA,     FR_EXCL,     FR_QUES,     FR_SCLN,     _______,
                         _______,    _______,     _______,     _______,     _______,     TY_NBSP,     TY_NBSP,    _______,     _______,     _______,     _______,     _______),
  ...
  [NUMB] = LAYOUT_planck_grid(
                             _______,    _______,     _______,     _______,     _______,     _______,     _______,    KC_7,        KC_8,        KC_9,        KC_PSCR,     _______,
                             _______,    _______,     _______,     _______,     _______,     _______,     _______,    KC_4,        KC_5,        KC_6,        TY_FGDA,     _______,
                             _______,    _______,     _______,     _______,     _______,     _______,     _______,    KC_1,        KC_2,        KC_3,        _______,     _______,
                             _______,    _______,     _______,     _______,     _______,     KC_SPC,      KC_SPC,     KC_0,        _______,     _______,     _______,     _______),
   ...
   *
   * .-----------------------------------------------------------------------------------.
   * | RICK |      |      |      |      | QKBT |      |  F7  |  F8  |  F9  | F12  |      |
   * |------+------+------+------+------+------+------+------+------+------+------+------|
   * | VICT |      |      |      |      | RGBR |      |  F4  |  F5  |  F6  | F11  |      |
   * |------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      |      |      |      |      |      |  F1  |  F2  |  F3  | F10  |      |
   * |------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      |      | RMOD | VAD  |     TOG     | VAI  |  MOD |      |      |      |
   * `-----------------------------------------------------------------------------------´
   */

  [FUNC] = LAYOUT_planck_grid(
                         ZP_RICK,    _______,     _______,     _______,     _______,     QK_BOOT,     _______,    KC_F7,       KC_F8,       KC_F9,       KC_F12,      _______,
                         ZP_VICT,    _______,     _______,     _______,     _______,     RGB_RESET,   _______,    KC_F4,       KC_F5,       KC_F6,       KC_F11,      _______,
                         _______,    _______,     _______,     _______,     _______,     _______,     _______,    KC_F1,       KC_F2,       KC_F3,       KC_F10,      _______,
                         _______,    _______,     _______,     RGB_RMOD,    RGB_VAD,     RGB_TOG,     RGB_TOG,    RGB_VAI,     RGB_MOD,     _______,     _______,     _______),
  ...
  [LMOD] = LAYOUT_planck_grid(
                         _______,    _______,     _______,     MO(RSYM),    _______,     _______,     _______,    _______,     _______,     _______,     _______,     _______,
                         _______,    LM_SUPR,     LM_LALT,     LM_LSFT,     LM_LCTL,     _______,     _______,    _______,     _______,     _______,     _______,     _______,
  ...
  [RMOD] = LAYOUT_planck_grid(
                         _______,    _______,     _______,     _______,     _______,     _______,     _______,    _______,     MO(LSYM),    _______,     _______,     _______,
                         _______,    _______,     _______,     _______,     _______,     _______,     _______,    RM_LCTL,     RM_LSFT,     RM_LALT,     RM_SUPR,     _______,
...
bool no_mods(void) {
  return !(get_mods() & (MOD_MASK_CTRL | MOD_MASK_SHIFT \
                         | MOD_MASK_ALT | MOD_MASK_GUI));
}
